...
const StrokeText = ({
  ...
  useEffect(() => {
    ...
    const strokes = gsap.utils.toArray(root.querySelectorAll('[data-stroke-char]')) as Element[];
    const fills = gsap.utils.toArray(root.querySelectorAll('[data-fill-char]')) as Element[];
